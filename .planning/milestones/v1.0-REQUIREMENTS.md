...
- [x] **ORG-01**: Admin can register a new organization with name, slug, and admin account
...
- [x] **ORG-04**: Organization admin can configure settings (timezone, default cadence, default duration)
- [x] **ORG-05**: Organization type supports both for-profit and non-profit models
...
*Last updated: 2026-03-05 before v1.0 milestone archival*
